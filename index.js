...
logs(client);
const { MOD_CHANNEL, SERVER, PREFIX } = require("./ayarlar.json");
...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase() === '!discord') {
    msg.reply('**Sanırım Bunu Arıyorsun Dostum** https://discord.gg/PtZK4qa5Yn');
  }
   if (msg.content.toLowerCase() === '!dc') {
    msg.reply('**Sanırım Bunu Arıyorsun Dostum** https://discord.gg/PtZK4qa5Yn');
  }
  if (msg.content.toLowerCase() === '!burakoyunda') {
